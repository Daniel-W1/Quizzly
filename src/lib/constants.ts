...
export const filterConcepts = [
  {
    ...
    concepts: [
      ...
      { value: "Fundamental of Database", label: "Fundamental of Database" },
      {
        value: "Fundamental of Networking",
        label: "Fundamental of Networking",
      },
  ...
  },
  {
    ...
    concepts: [
      { value: "Schools of Thought", label: "Schools of Thought" },
      { value: "Sensory Processes", label: "Sensory Processes" },
      { value: "Perception", label: "Perception" },
      { value: "Classical Conditioning", label: "Classical Conditioning" },
      { value: "Learning Theories", label: "Learning Theories" },
    ],
  },
];
